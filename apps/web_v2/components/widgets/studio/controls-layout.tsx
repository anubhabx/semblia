...
export function LayoutSection({ widgetId }: { widgetId: string }) {
  ...
  return (
    <SectionCollapsible title="Layout">
      {isWall && (
        <div className="mb-3 rounded-md border border-emerald-300/30 bg-emerald-50/60 px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-[0.12em] text-emerald-700 dark:border-emerald-300/15 dark:bg-emerald-950/30 dark:text-emerald-300">
